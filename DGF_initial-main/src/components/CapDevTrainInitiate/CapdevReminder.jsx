...
//       const dateStr = selectedDate.toISOString().split("T")[0];
//       const payload = {
//         assignment_id: assignmentId, // Dynamically send the assignment ID
//         reminder_date: dateStr,
//         reminder_text: reminderText,
//         created_by: createdBy, // Dynamically send the created_by value
//       };
...
const CapdevReminder = ({ assignmentId }) => {
  ...
  //       text: newReminder.reminder_text,
  //     });
                ...
                <ListItem
                  ...
                  secondaryAction={
                    <>
                      ...
                      {/* <IconButton edge="end" onClick={() => editReminder(selectedDateStr, index, reminder.text)}>
                        <EditIcon fontSize="small" />
                      </IconButton> */}
